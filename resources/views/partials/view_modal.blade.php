            ...
            <div class="modal-body">
              <form role="form" @submit.prevent="updateItem()">
                ...
                <div class="box-footer">
                    <button type="submit" class="btn btn-primary" id="send-post-btn" style="display:none;">Submit</button>
                    <input type='button' class="btn btn-warning" onclick="enable_disable()" value="Edit">
                    <p class="help-block">Click above button to update form.</p>
                </div>
